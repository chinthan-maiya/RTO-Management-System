						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="link-effect-2" id="link-effect-2">
								<ul class="nav navbar-nav">
									...
									<li><a href="codes.html"><span data-hover="Contact">Contact</span></a></li>
									<li><a href="contact.html"><span data-hover="Others">Others</span></a></li>
								</ul>
							</nav>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="student-grids">
						<div class="col-md-6 student-grid">
          				...
          				<button type="submit"  name="submit" onclick="return otp()" class="btn btn-primary">Submit</button>
          			</form>	</p>
								<p></p>
